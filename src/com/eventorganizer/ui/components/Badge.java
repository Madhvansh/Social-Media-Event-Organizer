...
/**
 * Small pill label. Reads background + foreground from one of seven palette
 * kinds. Rounded via paintComponent, not setBorder, so the rounding is
 * pixel-clean at the 11-12 px font sizes.
 *
 * <p>Use {@link #dot(Color)} for 8 px pulse dots (unread indicators).
 */
public class Badge extends JLabel {

    public enum Kind { DEFAULT, ACCENT, ACCENT2, SUCCESS, WARNING, DANGER, INFO }
    ...
    private static Kind kindFromColor(Color c) {
        ...
        if (c.equals(Theme.ACCENT2)) return Kind.ACCENT2;
    ...
    private void applyKind(Kind kind) {
        switch (kind) {
            ...
            case ACCENT2: fill = Theme.ACCENT2_SOFT;  strokeColor = Theme.ACCENT2; break;
            ...
            case DEFAULT:
            default:      fill = Theme.BG_OVERLAY;    strokeColor = Theme.BORDER;  break;
        }
    }
    ...
    private void setForegroundByKind(Kind kind) {
        switch (kind) {
            ...
            case ACCENT2: setForeground(Theme.ACCENT2);  break;
            ...
            case DEFAULT:
            default:      setForeground(Theme.TEXT_SECONDARY); break;
        }
    }

    /** Returns a small 10 px circular dot badge (no text) for unread indicators. */
    public static javax.swing.JComponent dot(Color color) {
        return new DotBadge(color);
    }
    ...
    private static final class DotBadge extends javax.swing.JComponent {
